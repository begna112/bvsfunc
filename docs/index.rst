...
.. autosummary::
   ...
   bvsfunc.util.VideoSource
   bvsfunc.util.MPLSSource
...
.. code-block:: python
    ...
    if process:
        ...
        bvs.util.video_source(infile=filepath, trimlist=autotrims, noflac=True, silent=True)
    ...
    if process:
        audiotrims = [[None,500],[1000,2000]]
        bvs.util.mpls_source(mplsdict=mpls, trimlist=audiotrims, noflac=True, silent=False)
